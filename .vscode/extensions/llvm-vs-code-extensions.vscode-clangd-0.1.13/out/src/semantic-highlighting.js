...
class SemanticHighlightingFeature {
    ...
    handleNotification(params) {
        const lines = params.lines.map((line) => { var _a; return ({ line: line.line, tokens: decodeTokens((_a = line.tokens) !== null && _a !== void 0 ? _a : '') }); });
 ...
 *     been set.
 */
function parseThemeFile(fullPath, seenScopes = new Set()) {
    return __awaiter(this, void 0, void 0, function* () {
